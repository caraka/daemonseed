...
- `daemonseed-isc`: ISC-C99 (circle-chat per-sender authorship) is tracked in the coverage registry — present in `ISCS` (TOTAL 200→201) and integration-covered via `cot_chat_e2e` (COVERED 110→111); it previously had only unit coverage (#150).
