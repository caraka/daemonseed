...
**A public room and a private circle behave identically in every respect except how their key is derived (2026-06-28).** The sole branch point across the whole stack is the key-derivation function:
