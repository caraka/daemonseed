...
mod tests {
    ...
    fn registry_class_distribution_matches_agents_md() {
        ...
        //                                  CRSH-ISC-1/2/9/3/18/5/6/19/8/10/13/21/22/23/24 pos (sweep
