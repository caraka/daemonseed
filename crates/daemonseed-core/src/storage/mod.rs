...
//!   `daemonseed.toml`.
//! - [`cas`] — the content-addressed chunk store: opaque encrypted
...
//!   cache).
//! - [`share_index`] — the redb-backed indexed-state layer: a persistent,
//!   incremental, per-value-encrypted index of a shared folder's files
//!   (ISC-C21 / A-C6 / A-C7).
//! - [`fetched`] — the persistent landing zone for *fetched* share
