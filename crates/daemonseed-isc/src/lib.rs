...
//! - 119 client-side: 83 positive (`ISC-C*`) + 36 negative (`ISC-A-C*`)
...
mod tests {
    ...
    fn registry_class_distribution_matches_agents_md() {
        ...
        //   total   115 pos + 61 neg = 176
        assert_eq!(pos, 115, "positive count drift");
